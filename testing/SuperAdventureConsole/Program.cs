...
namespace SuperAdventureConsole
{
    public class Program
    {
        ...
        private static void ParseInput(string input)
        {
            ...
            else if (input == "quests")
            {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("{0}: {1}", playerQuest.Name, playerQuest.IsCompleted);
                    }
                }
            }
            ...
            //Blank line to keep it looking clean
            Console.WriteLine("");
        }
        ...
        private static void BuyItem(string input)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    _player.CurrentLocation.VendorWorkingHere.Inventory.SingleOrDefault(x => x.Details.Name.ToLower() == itemName);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("You bought one {0} for {1} gold",
        ...
        private static void DrinkPotion(string input)
        {
            ...
            else
            {
                HealingPotion potionToDrink =
                    _player.Potions.SingleOrDefault(x => x.Name.ToLower() == inputPotionName || x.NamePlural.ToLower() == inputPotionName);
        ...
        private static void EquipWeapon(string input)
        {
            ...
            else
            {
                Weapon weaponToEquip =
                    _player.Weapons.SingleOrDefault(x => x.Name.ToLower() == inputWeaponName || x.NamePlural.ToLower() == inputWeaponName);
        ...
        private static void DisplayCurrentLocation()
        {
            ...
            if(_player.CurrentLocation.Description != null)
            {
